...
public class Medium extends AppWidgetProvider {
	private static String WIDGET_UPDATE = "com.aluxian.apps.timeloid.MEDIUM_WIDGET_UPDATE";
	...
	private void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
		...
		RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.medium);
