...
public class Large extends AppWidgetProvider {
	private static String WIDGET_UPDATE = "com.aluxian.apps.timeloid.LARGE_WIDGET_UPDATE";
	...
	private void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
		...
		RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.large);
